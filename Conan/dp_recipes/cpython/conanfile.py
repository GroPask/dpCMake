...
# Modified version of
# https://bintray.com/mercenariesengineering/conan_packages/cpython%3Amercseng
# (modified to not have OpenSSL and zlib pointed to mercseng version)
...
#       endif /* Py_BUILD_CORE */
    ...
    def package(self):
        ...
        if self.settings.os != "Windows":
            ...
            zipName = "python39.zip"
            if self.settings.build_type == "Debug":
                zipName = "python39_d.zip"
            zipf = zipfile.ZipFile(self.package_folder + "/" + zipName, 'w', zipfile.ZIP_DEFLATED)
            self.zipdir(self.package_folder + "/DLLs", zipf)
            self.zipdir(self.package_folder + "/Lib", zipf)
            zipf.close()
